<template>
  <div class="exam-manager-page">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h1 class="h3 mb-0">Quản lý đề thi JLPT</h1>
            ...
            <template v-else-if="examDetail">
              ...
              <div class="view-questions-list">
                ...
                >
                  ...
                  />
                  <p v-if="q.audio?.audioUrl" class="small text-muted mb-1">Âm thanh: {{ q.audio.audioUrl }}</p>
                  <p class="small mb-0">
...
async function viewExam(exam) {
  examToView.value = exam;
  examDetail.value = null;
  viewLoading.value = true;
  try {
    const res = await axiosInstance.get(`/exams/${exam._id}`);
